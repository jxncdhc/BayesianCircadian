...
bayes_rhythmicity <- function(yy, tt, period=24, M=3000, alpha00_nc = 0, alpha00_c = 0, beta10_c = 0, beta20_c = 0, tau2a_nc = 10, tau2a_c = 10, tau2b1_c = 10, tau2b2_c = 10, mu0_nc = 0, mu0_c = 0, nu0_nc = 0, nu0_c = 0, a_p = 1, b_p = 1){  
